      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-4 w-full py-16 lg:py-0">
        <div className="max-w-3xl">
          ...
          <div className="max-w-2xl">
            <p className="text-sm md:text-base lg:text-lg text-slate-800 font-inter leading-relaxed mb-6">
              We architect scalable software platforms, from fintech payment solutions to
              enterprise grade systems engineered for performance, security, and
              long-term growth.
            </p>
    ...
    {[...techStack, ...techStack].map((tech, i) => {
      ...
      return (
        ...
        >
          ...
          <span className="text-[0.7rem] lg:text-xs font-medium">{tech.name}</span>
        </div>
      );
    })}
  </div>
